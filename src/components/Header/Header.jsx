...
export default function Header() {
  ...
  useEffect(() => {
    ...
    if (top > 400 && !headerRef.current.classList.contains(styles.active)) {
      ...
      <header className={styles.header} ref={headerRef}>
        <div className={styles.left}>
          ...
          <nav className={styles.nav}>
            <button className={styles.nav_el}>Products</button>
            <button className={styles.nav_el}>Solutions</button>
            <a href="#" className={styles.nav_el}>
              Enterprise
            </a>
            <a href="#" className={styles.nav_el}>
              Pricing
        ...
        <div className={styles.right}>
          ...
          <nav className={styles.nav}>
            ...
            <button className={styles.nav_el}>Get app</button>
          </nav>
          ...
          <button className={styles.nav_el + " " + styles.started}>
            Get started
          </button>
        </div>
      </header>
